...
const sdkVersion = TelegramWebApp.version.split('.').map((v) => parseInt(v, 10));
...
export class SWStorage {
  ...
  private cloudStorage = TelegramWebApp.CloudStorage;
      ...
      await new Promise((resolve) => {
        ...
        this.cloudStorage.getKeys((err, keys) => {
          ...
          this.cloudStorage.getItems(keys, (err2, items) => {
            ...
            console.log('Storage sync success', keys);
