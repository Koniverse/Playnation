...
export interface ExtrinsicDataTypeMap {
  ...
  [ExtrinsicType.REMARK_WITH_EVENT]: any
}
...
export interface KoniRequestSignatures {
  ...
  'pri(transactions.subscribe.one)': [RequestSubscribeTransactionById, SWTransactionBrief, SWTransactionBrief];
