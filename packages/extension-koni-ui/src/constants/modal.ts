...
export const ACCESS_HOME_SCREEN_MODAL = 'access-home-screen-modal';
export const PWA_INSTRUCTION_MODAL = 'pwa-instruction-modal';
export const PWA_WELCOME_MODAL = 'pwa-welcome-modal';
