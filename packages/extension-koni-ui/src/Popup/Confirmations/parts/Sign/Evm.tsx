...
import { WC_DEFAULT_CHAIN_MAINNET_ID, WC_USER_REJECT_MESSAGE } from '@subwallet/extension-base/services/wallet-connect-service/constants';
...
const Component: React.FC<Props> = (props: Props) => {
  ...
  const chainId = (payload.payload as EvmSendTransactionRequest)?.chainId || WC_DEFAULT_CHAIN_MAINNET_ID;
